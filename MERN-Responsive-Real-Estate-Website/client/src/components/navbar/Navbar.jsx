...
const Navbar = () => {
  ...
  useEffect(() => {
    setState((prev) => {
      return { ...prev, continent: "europe", type: "city" };
    });
  }, []);
      ...
      <div className={classes.wrapper}>
        ...
        <ul style={{ paddingLeft: "0" }} className={classes.centerImp}>
          ...
          <li className={classes.listItem}>
            <Link to="/about" className={classes.linker}>
              About
            </Link>
          </li>
          <li className={classes.listItem}>
          ...
          <li className={classes.listItem}>
            <Link to="/Contacts" className={classes.linker}>
              Contacts
            </Link>
          </li>
        </ul>
              ...
              {showModal && (
                <div className={classes.userModal}>
                  ...
                  >
                    ...
                    <div className={classes.listProp}>List your flat</div>
                  </Link>
                </div>
              )}
            </>
